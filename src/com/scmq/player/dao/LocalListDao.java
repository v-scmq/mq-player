...
public interface LocalListDao {
     ...
     * <ol>
     * <li>column like '%${key}%' 的方式(默认)</li>
     * <li>column like #{key} 的方式,但必须先处理key变量的值为'%实际内容%'</li>
     * </ol>
     *
     * @param id  本地音乐列表id
     * @param key 搜索关键词
     ...
     *
     * @param localListId 本地音乐列表id
     * @param musicList   音乐信息的List集合
     * @return 保存成功的数量
     */
     ...
     *
     * @param mediaIds 本地音乐列表项媒体id的{@code int[]}
     * @return 删除成功的数量
     */
